      ...
      <div class="header-top">
        ...
        <div class="header-actions">
          <ng-container *ngIf="!hideWatchFork">
            ...
            <button class="btn btn-secondary" (click)="onFork()">
          ...
          <button class="btn btn-secondary" (click)="onStar()">
...
export class RepositoryHeaderComponent {
  ...
  @Output() star = new EventEmitter<void>();
  ...
  onFork() {
    ...
    if (confirm('¿Deseas crear una copia (fork) de este proyecto?')) {
      alert('🍴 Fork creado exitosamente! Redirigiendo a tu copia...');
      this.fork.emit();
    }
  }
